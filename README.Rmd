...
package is built on top of the copula density estiamtors in [kdecopula](https://github.com/tnagler/kdecopula) and
let's you choose from all its implemented methods.

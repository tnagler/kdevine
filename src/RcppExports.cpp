...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const NumericVector >::type x(xSEXP);
    __result = Rcpp::wrap(ikern_gauss(x));
    return __result;
END_RCPP
}
// eval_kde1d
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(eval_kde1d(xsort, xev, xmin, xmax, bw));
    return __result;
END_RCPP
}
// eval_pkde1d
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type xmax(xmaxSEXP);
    Rcpp::traits::input_parameter< const double >::type bw(bwSEXP);
    __result = Rcpp::wrap(eval_pkde1d(x, xev, xmin, xmax, bw));
    return __result;
END_RCPP
}
// eval_qkde1d
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type xmax(xmaxSEXP);
    Rcpp::traits::input_parameter< const double >::type bw(bwSEXP);
    __result = Rcpp::wrap(eval_qkde1d(x, qev, xmin, xmax, bw));
    return __result;
END_RCPP
}
